...
**_isHiddenFromMenu** (boolean): If you want to hide a content object from the menu, set this to `true`. This can be useful if, for example, you have a content object defined as a 'start page' for the course which you don't want to be listed on the menu since the user will have already seen it.
